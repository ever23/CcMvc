...
use Cc\Mvc;
use Cc\Mvc\Session\HookSaveController;
...
trait PropertiesInSession
{
    ...
    {
        HookSaveController::HookAutenticate()->Clean();
    }
    ...
    {
        return HookSaveController::HookAutenticate()->Get($property, $controller);
    }
    ...
    {
        HookSaveController::HookAutenticate()->Set($property, $value, $controller);
    }
